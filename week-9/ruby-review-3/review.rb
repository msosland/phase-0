...
# It has been a while since I worked with Ruby classes so I am trying to go through these challenges to get a refresher. This challenge helped a little with seeing objects from one class interact with another class.
# What is still confusing to you about Ruby?
# Nothing was too confusing from this exercise, but I need to keep working with classes interacting with each other. Also, writing a lot of driver code and parsing through it.
# What are you going to study to get more prepared for Phase 1?
# Trying to re-read some of the Rubyist to get back into Ruby.