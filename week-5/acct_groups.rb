...
#Running this code multiple times will provide multiple outputs because of the list_copy.shuffle! method. If you want the same groups every time, take that out.
...
# I ended up just popping 4 people every time.. instead of randomly popping 4 or 5. Also, I originally wanted to randomly remove people from
...
# I think its pretty good but it does have multiple iterating loops.
...
# The only method I used in my solution that I had not used before was shuffle! So the rest are pretty basic (each, push, and pop). But there might be a better solution....
